...
$(document).ready(function () {
  ...
  $("#getting-started")
    ...
    .countdown("2020/8/4 23:59:30", function (event) {
      $(this).html(
        event.strftime("%D")
  ...
  function init() {
    ...
    var center = new google.maps.LatLng(40.68, -74.00487);
    ...
    var locations = [
      [
        '<h6>Bondi Beach, East Coast</h6><p>This is where we are currently, the sun goes down...<br><i class="fa fa-coffee"></i> Visit us, we pay the coffee!</p>',
        40.4,
        -74.0,
        1,
      ],
      [
        '<h6>Coogee Beach, East Coast</h6><p>Opening Hours<br><i class="fa fa-clock-o"></i> 8:00 to 22:00</p>',
        40.6,
        -73.9,
        2,
      ],
      [
        '<h6>Manly Beach, East Coast</h6><p>Opening Hours<br><i class="fa fa-clock-o"></i> 6:00 to 14:00</p>',
        40.76759,
        -73.96756,
        3,
      ],
      [
        '<h6>Maroubra Beach, East Coast</h6><p>Opening Hours<br><i class="fa fa-clock-o"></i> 12:00 to 23:30</p>',
        40.9700171,
        -73.7176337,
        4,
      ],
